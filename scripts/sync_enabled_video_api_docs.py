...
SPECS = (
    ...
    s("cy-sd4-happyhouse-1.1", "happyhouse-1.1", "video-tpl-happyhouse-1.1-async", "duration resolution aspect_ratio generate_audio reference_image_urls"),
    s("cy-sd4-minimax-h3-768p", "minimax-h3-768p", "video-tpl-minimax-h3-2k-async", "aspect_ratio duration resolution generate_audio reference_image_urls reference_videos reference_audios first_image_url last_image_url"),
    s("cy-sd4-minimax-h3-2k", "minimax-h3-2k", "video-tpl-minimax-h3-2k-async", "aspect_ratio duration resolution generate_audio reference_image_urls reference_videos reference_audios first_image_url last_image_url"),
    s("cy-sd4-minimax-h3-4k", "minimax-h3-4k", "video-tpl-minimax-h3-2k-async", "aspect_ratio duration resolution generate_audio reference_image_urls reference_videos reference_audios first_image_url last_image_url"),
    ...
    s("cy-sd4-seedance-2.0-mini-8s", "seedance-2.0-mini-8s", "video-tpl-seedance-mini-8s-async", "aspect_ratio duration resolution generate_audio reference_image_urls reference_videos reference_audios first_image_url last_image_url"),
