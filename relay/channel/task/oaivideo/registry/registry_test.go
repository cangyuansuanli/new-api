...
func TestResolve(t *testing.T) {
	cases := []struct {
		...
		{"cy-sd4-minimax-h3-768p", "hailuo-03", VendorSeedanceLeonardo},
		{"cy-sd4-minimax-h3-4k", "hailuo-03", VendorSeedanceLeonardo},
		{"cy-sd4-seedance-2.0", "seedance-2.0-fast", VendorSora},
		{"cy-sd4-minimax-h3-4k", "seedance-2.5", VendorSora},
