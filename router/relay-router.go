...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.PublicModelNameForRetrieve())
	{
	...
	}
	{
		...
		httpRouter.POST("/audio/generations", controller.RelayOpenAIAudioGenerations)
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.PublicModelName(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.PublicModelName())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.PublicModelName(), middleware.Distribute())
	{
