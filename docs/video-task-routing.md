...
| `cy-sd5-seedance*` | Adobe2API Seedance | 渠道 75/86 与 Adobe 视频共用 `adobe` vendor；86 渠道展示名为 `Adobe2API 视频`，不再使用 `adobe-direct-sd5-video`；mapping 使用 `seedance-2.0` / `seedance-2.0-fast` | `video.generation` → OpenAI Video 形 |
